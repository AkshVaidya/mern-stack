...
function AnimatedArea(props) {
  ...
  return (0, import_jsx_runtime51.jsx)(AppearingMask, {
    ...
    children: transitionChange((style, interpolator) => (0, import_jsx_runtime51.jsx)(AreaElementPath, _extends({}, other, {
      ownerState,
...
function AnimatedLine(props) {
  ...
  return (0, import_jsx_runtime54.jsx)(AppearingMask, {
    ...
    children: transitionChange((style, interpolator) => (0, import_jsx_runtime54.jsx)(LineElementPath, _extends({}, other, {
      ownerState,
      d: style.value.to(interpolator)
    })))
  });
...
function PieArcLabel(props) {
  ...
  return (0, import_jsx_runtime65.jsx)(PieArcLabelRoot, _extends({
    className: classes.root
  }, other, {
    style: _extends({
